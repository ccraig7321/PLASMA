...
$.ajax(settings).done(function (musicData) {
    ...
    addSongButton.attr("class", "button is-rounded is-success is-small is-light");
...
$("#songClearButton").on("click", clear);
...
const queryURL = "http://ws.audioscrobbler.com/2.0/?method=artist.gettoptracks&artist=" + searchTerm + "&api_key=a2d086840baaf07f39dd4fcf09c18ff7&format=json";
...
// The on "click" function that is associated with the "delete" button.
$("#artistClearButton").on("click", clear);